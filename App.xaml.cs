...
namespace LoL_Generator
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            Console.WriteLine(LoL_Generator.Properties.Settings.Default.Left);
            Console.WriteLine(LoL_Generator.Properties.Settings.Default.Top);
                    ...
                    if (gamephase == "\"ChampSelect\"")
                    {
                        ...
                        if (!listedSets)
                        {
                            ...
                            Action act = () => {
                                ...
                                {
                                    if (runePage.isEditable && runePage.id != LoL_Generator.Properties.Settings.Default.runePageID)
                                    {
                        ...
                        if (!autoGenerated && generatedFor != champion + currole && championLockId != "0" && championLockId != default && champion != default && currole != default)
                        {
                            Action act = () =>
                            {
